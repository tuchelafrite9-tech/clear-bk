      ...
      <td style="padding:40px 40px 20px;">
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
          <tr><td style="text-align:center;">
            <a href="https://clear-bk.com/forgot-password" target="_blank" style="display:inline-block;background:#0c7981;color:#ffffff;text-decoration:none;padding:16px 40px;border-radius:9999px;font-family:'Inter',Arial,sans-serif;font-weight:600;font-size:16px;letter-spacing:0.3px;">Définir mon mot de passe</a>
          </td></tr>
        </table>
