# Migration Base44 vers Supabase

1. Dans le SQL Editor Supabase, exécutez `migrations/20260804_base44_replacement.sql`.
...
6. Migrez les données Base44 avant la coupure, puis retirez les variables Base44 seulement après validation.
